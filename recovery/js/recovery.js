...
var activeCounty, activeDimension, addCommas, allCountyData, arc, axis, axisk, bb, blockContextMenu, canvasHeight, canvasWidth, color, colorDomains, compressData, compressedData, constant, containsAll, counties, countyAdded, countyLine, countyPoints, countyTitle, defaultPath, dimension, dimensions, drawPC, drawVisualization, firstTime, foreground, formatPercent, formatk, formats, generateLabels, graphContainer, graphFrame, graphLine, graphMask, graphXAxis, graphXScale, graphYAxis, graphYScale, graphedCountyId, keyFrame, keyLabels, labels, line, loadingContainer, mapContainer, mapFrame, mapMask, mapX, mapY, meter, modifyGraph, nationalData, nationalLine, nationalPoints, nationalTitle, parseDate, path, pcBackground, pcBrush, pcFocus, pcForeground, pcFrame, pcNational, pcPath, pcScales, pcx, pcy, progress, projection, resetChoropleth, scaleY, standardMargin, svg, text, timeSlice, total, twoPi, units, usGeo, vsText, windowHeight, windowWidth, yAxis, yLabel, zeroes, zoomChoropleth, _i, _len, _ref, _ref1, _ref2;
...
d3.json("../data/compressed-nationwide-data.json", function(nationwide) {
  return d3.json("../data/compressed-augmented-us-states-and-counties.json").on("progress", function() {
    var interpolator;
