...
var activeCounty, activeDimension, addCommas, allCountyData, axis, axisk, bb, blockContextMenu, canvasHeight, canvasWidth, color, colorDomains, compressData, compressedData, constant, containsAll, counties, countyAdded, countyLine, countyPoints, countyTitle, defaultPath, dimension, dimensions, drawPC, drawVisualization, firstTime, formatk, formats, generateLabels, graphContainer, graphFrame, graphLine, graphMask, graphXAxis, graphXScale, graphYAxis, graphYScale, graphedCountyId, keyFrame, keyLabels, labels, line, loadingContainer, mapContainer, mapFrame, mapMask, mapX, mapY, meter, modifyGraph, nationalData, nationalLine, nationalPoints, nationalTitle, parseDate, path, pcBackground, pcBrush, pcFocus, pcForeground, pcFrame, pcNational, pcPath, pcScales, pcx, pcy, projection, resetChoropleth, scaleY, standardMargin, svg, text, timeSlice, units, usGeo, vsText, windowHeight, windowWidth, yAxis, yLabel, zeroes, zoomChoropleth, _i, _len, _ref, _ref1, _ref2;
